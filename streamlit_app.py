    ...
    with col2:
        ...
        with st.spinner('Generating indices...'):
            ...
            {'type':'text',
                ...
                "'text_in_image' should be a list of all the TEXTUAL words/phrases present in the image. This field should be left empty if there is no text in the image. Parts of text OF THE SAME LANGUAGE that appear together in the image should be output as a single string in the list, while text of different languages should be returned as separate strings."
                },
                {'type':'image_url',
                'image_url':{'url':f"data:image/jpeg;base64,{b64Str}"}
                }
